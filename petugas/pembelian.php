                    ...
                    <div class="modal-body">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="nama_pelanggan" class="form-control" value="<?php echo $d['nama_pelanggan'];?>" class="form-control">
                                        ...
                                        <div class="form-group">
                                            <label>No. telp</label>
                                            <input type="text" name="nomor_telepon" class="form-control" value="<?php echo $d['nomo_telepon'];?>" class="form-control">
                                        </div>
                                        <div class="form-group">
                                            <label>Alamat</label>
                ...
                <div class="modal fade" id="hapus-data<?= $d['id_pelanggan'] ?>" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                        <div class="modal-dialog">
                            <div class="modal-content">
                                ...
                                <form action="proses_hapus_pemebelian.php" method="post">
                                    <div class="modal-body">
