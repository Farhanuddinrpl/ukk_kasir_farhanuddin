    ...
    <div class="modal-content">
        ...
        <form action="proses_simpan_petugas.php" method="post">
            <div class="modal-body">
                <div class="form-group">
                    <label>Nama Petugas</label>
                    <input type="text" requered name="nama_petugas" class="form-control">
                </div>
                <div class="form-group">
                    <label>Username</label>
                    <input type="text" requered class="form-control" name="username">
                </div>
                <div class="form-group">
                    <label>Password</label>
                    <input type="text" requered class="form-control" name="password">
                </div>
                <div class="form-group">
                    <label>Akses Petugas</label>
